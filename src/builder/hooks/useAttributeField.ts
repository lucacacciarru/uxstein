...
import { UpdateAttributeValuePayload } from '../store/types/updateAttributeValue';
...
export const useAttributeField = (
    ...
    const debouncedUpdateValue = useDebouncedCallback((items: UpdateAttributeValuePayload['items']) => {
        dispatch(
